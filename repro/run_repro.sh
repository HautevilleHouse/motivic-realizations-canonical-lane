...
mkdir -p .tmp/motivic_realizations
cp artifacts/stitch_constants.json .tmp/motivic_realizations/stitch_constants.json
cp artifacts/constants_registry.json .tmp/motivic_realizations/constants_registry.json
