...
mkdir -p .codex_tmp/motivic_realizations
cp artifacts/stitch_constants.json .codex_tmp/motivic_realizations/stitch_constants.json
cp artifacts/constants_registry.json .codex_tmp/motivic_realizations/constants_registry.json
python3 scripts/mrf_closure_guard.py --strict-coh-zero --registry artifacts/constants_registry.json --stitch artifacts/stitch_constants.json --out repro/certificate_runtime.json --history repro/drift_guard_runs.jsonl --pretty
