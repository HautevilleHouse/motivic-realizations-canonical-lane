...
mkdir -p .repro_tmp/motivic_realizations
cp artifacts/stitch_constants.json .repro_tmp/motivic_realizations/stitch_constants.json
cp artifacts/constants_registry.json .repro_tmp/motivic_realizations/constants_registry.json
