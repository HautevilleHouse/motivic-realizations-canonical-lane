...
`sigma_filtration^(raw) := filtration_floor_raw - support_loss_raw - restart_loss_raw`.
...
Main interpretation: the tracked filtration defect does not consume the full closure budget.
